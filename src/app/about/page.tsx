    ...
    <div className="py-12 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
      <div className="text-center space-y-4">
        ...
        <p className="text-sm text-neutral-500 font-sans max-w-xl mx-auto leading-relaxed">
          Architectural precision meets sensual silk satins. UNI was founded to redefine high-end women's fashion through modern, uncompromising luxury craftsmanship.
        </p>
      </div>

      <div className="relative aspect-[16/9] w-full rounded-3xl overflow-hidden bg-neutral-900 shadow-2xl">
        <Image src="/images/editorial-banner.jpg" alt="UNI Atelier Paris Runway" fill className="object-cover" />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 text-xs text-neutral-600 leading-relaxed font-sans">
        ...
        <div className="space-y-4">
          ...
          <p>
            UNI bridges the space between high fashion week runway design and wearable power silhouettes. Designed to empower confidence, elegance, and sensual luxury for women across the globe.
          </p>
        </div>
      </div>
    </div>
